<?
	...
	class Line {
		...
		public function sendTodatabase() {
			$ch = curl_init();
			curl_setopt($ch, CURLOPT_URL, "https://api.cloudmine.me/v1/app/a467ad970b844ddebf2abcfbc846b71e/text");
			curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-Type: application/json', 'X-CloudMine-ApiKey: 4c87538b9c3046e0ab06aafbe2826ce5'));
			$id = uniqid('');
			$data = json_encode(array($id => array($this->lines, $this->hashtags)));
